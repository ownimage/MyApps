// CountMyDays — shadow-root CSS constants for the editors and the style
// injection helper (adopted via the shared SmdStyles). The generic editor form
// styles are shared with PlanMyDay (JOBS_EDITOR_STYLES); SETTINGS_STYLES lives
// in shared/js/smd-settings.js, and CMD_EDITOR_STYLES holds the CountMyDays
// additions (the shared injectSettingsStyles() composes them).
...
// CountMyDays additions on top of the generic JOBS_EDITOR_STYLES: card
// surfaces (shadow roots don't get Bootstrap) plus the utility classes the
// date/category/export/import pages use.
var CMD_EDITOR_STYLES = `
  .smd-page-body .card, .smd-tab-panel .card {
    background-color: var(--bs-dark-border-subtle, #303030);
    border: 1px solid var(--bs-border-color, #495057);
    border-radius: 0.375rem;
    color: var(--bs-body-color, #eee);
  }
  .smd-page-body .p-3, .smd-tab-panel .p-3 { padding: 1rem; }
  .smd-page-body .d-flex, .smd-tab-panel .d-flex { display: flex; }
  .smd-page-body .flex-column, .smd-tab-panel .flex-column { flex-direction: column; }
  .smd-page-body .gap-2, .smd-tab-panel .gap-2 { gap: 0.5rem; }
  .smd-page-body .gap-3, .smd-tab-panel .gap-3 { gap: 1rem; }
  ...
  .smd-page-body .align-items-start, .smd-tab-panel .align-items-start { align-items: flex-start; }
  .smd-page-body .text-center, .smd-tab-panel .text-center { text-align: center; }
  .smd-page-body .text-end, .smd-tab-panel .text-end { text-align: right; }
  ...
  .smd-page-body .mb-3, .smd-tab-panel .mb-3 { margin-bottom: 1rem; }
  .smd-page-body .mb-4, .smd-tab-panel .mb-4 { margin-bottom: 1.5rem; }
  .smd-page-body .mt-1, .smd-tab-panel .mt-1 { margin-top: 0.25rem; }
  .smd-page-body .mt-2, .smd-tab-panel .mt-2 { margin-top: 0.5rem; }
  ...
  .smd-page-body .list-unstyled, .smd-tab-panel .list-unstyled { list-style: none; padding-left: 0; margin: 0; }
  .ew-thumb-empty { width: 32px; height: 32px; flex: 0 0 auto; }
  .cmd-scroll-list { max-height: 55vh; overflow-y: auto; }
`;
